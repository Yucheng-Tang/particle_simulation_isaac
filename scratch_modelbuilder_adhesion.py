...
class Example:
    def __init__(self, stage_path="scratch_modelbuilder_adhesion.usd"):
        fps = 60
        ...
        self.model.particle_adhesion = 0.01
    ...
    def simulate(self):
        logging.info(f"shape count:{self.model.shape_count}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="scratch_modelbuilder_adhesion.usd",
